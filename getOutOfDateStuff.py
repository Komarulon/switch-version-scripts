...
# or this file: https://raw.githubusercontent.com/masagrator/version_dump/refs/heads/main/version_dump.txt
# 3. Run this script:
# python getOutOfDateStuff.py working.txt
# or
# python getOutOfDateStuff.py version_dump.txt
...
with open(sys.argv[1], 'r') as my_file:
    for line in my_file:
        ...
        if len(splitLine) > 1:
            ...
            if len(splitLine) == 2: #0100C2E01C520000|0 - working.txt
                titleId = splitLine[0];
                version = int(splitLine[1]);
            else: # id|rightsId|version - version_dump.txt
                titleId = splitLine[0];
                if (titleId == 'id'):
                    continue;
